...
**It stays out of the way.** ~2,303 tokens of always-on context, nothing injected
...
**~2,303 tokens** of always-on context, and nothing injected per tool call. Treat
...
`./scripts/measure-context.sh` re-derives it, and also prints **2,600 on a chars/4 basis**, the estimate this project's version series is tracked on.

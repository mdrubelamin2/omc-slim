...
**It stays out of the way.** ~2,467 tokens of always-on context, nothing injected
...
**~2,467 tokens** of always-on context, and nothing injected per tool call. Treat
...
`./scripts/measure-context.sh` re-derives it, and also prints **2,791 on a chars/4 basis**, the estimate this project's version series is tracked on.

...
- Touch target under 24×24 CSS px — the WCAG 2.2 AA floor (2.5.8). 44×44 is the Apple convention, not the standard, and flagging against it makes this plugin file findings on its own compliant work

...
**Design decisions.** A phase that produced UI records its important visual decisions in the progress file, because the next phase reads that file and not the transcript where they were explained.

...
Opened from [`SKILL.md`](./SKILL.md), not read by default. Everything here is
conditional: it applies to a decision you are actually facing, and reading it
when you are not is cost with no return.

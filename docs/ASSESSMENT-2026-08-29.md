...
2,467 tokens of always-on context, plus on-invoke bodies up to 27,686 if
everything fires.
...
Anthropic's own guidance says recall degrades as the window fills. So 4,666
tokens is not free even when it is free. It is 2,467 tokens of the budget that
...
negate the need for this set of skills?"* A 2,467-token plugin is judged against

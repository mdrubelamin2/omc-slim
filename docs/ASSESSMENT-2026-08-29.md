...
2,590 tokens of always-on context, plus on-invoke bodies up to 28,892 if
everything fires.
...
tokens is not free even when it is free. It is 2,590 tokens of the budget that
...
negate the need for this set of skills?"* A 2,590-token plugin is judged against

...
4,666 tokens of always-on context, plus on-invoke bodies up to 33,995 if
everything fires.
...
tokens is not free even when it is free. It is 4,666 tokens of the budget that
...
negate the need for this set of skills?"* A 4,666-token plugin is judged against

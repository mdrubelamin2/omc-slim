...
| Cost attribution per rule | `token-warden` — every rule pays rent against a frozen benchmark or is evicted | This plugin ships ~2,590 always-on tokens with no per-component accounting |

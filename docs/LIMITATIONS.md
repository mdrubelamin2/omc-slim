...
about **420 tokens**, so the true always-on cost is nearer 2,480 than the ~2,303 this repository publishes.
...
every release: 2,774 at v0.1.0 against 2,600 today, though not monotonically.

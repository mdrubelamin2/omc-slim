...
about **420 tokens**, so the true always-on cost is nearer 2,644 than the ~2,467 this repository publishes.
...
The ceiling if every component fires once is **30,689 chars/4, ~27,686 corrected**.
...
every release: 2,774 at v0.1.0 against 2,791 today, though not monotonically.

...
is nearer 3,343 than the ~2,703 this repository publishes.
...
SKILL.md, frontmatter included, is 5,638 tokens on the chars/4 basis, ~5,145 corrected —
...
The ceiling if every component fires once is **31,420 chars/4, ~28,265 corrected**.
...
every release: 2,774 at v0.1.0 against 3,061 today, though not monotonically.
